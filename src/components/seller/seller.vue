<template>
  <div class="seller" ref="sellerinfo">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        // favorite: (() => {
        //   return loadFromSession(this.sellerinfo.name+ 'favorite', false);
        // })()
      };
    },
    computed: {
    ...
    methods: {
      toggleFavorite(event) {
        ...
        // saveToSession(this.sellerinfo.name+ 'favorite', this.favorite);
      },
      _initScroll() {
        if (!this.scroll) {
          this.scroll = new BScroll(this.$refs.sellerinfo, {
            click: true
          });
        } else {
          this.scroll.refresh();
