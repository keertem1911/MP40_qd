<template>
    <div id="detail">
            ...
            <div  class="restaurant-card" >
                ...
                <div  class="product-list ">
                    <ul  class="cart-item" v-for="orderDetail in orderDetailList">
                        <li  class="product-item listitem">
                            <div  class="profile">
            ...
            <div  class="detailcard" >
                ...
                <div  class="detailcard-delivery card">
                    ...
                    <ul  class="cardlist">
                        ...
                        <li  class="listitem"><span >送货地址：</span>
                            <div  class="content" style="flex: 1;text-align: right">
                                <p >{{order.buyerName}}</p>
                                <p style="margin: 8px 0 8px 0">{{order.buyerPhone}}</p>
              ...
              <div  class="detailcard-order "><button class="backbtn" @click="$router.go(-1)">返回</button></div>
            </div>
